...
async def bot_runner(room_url, token, bot_name: BotName = "openai"):
    """Launch the provided bot process, providing the given room URL, token for the bot to join.

    Args:
        room_url (str): The URL of the room where the bot will operate.
...
class ConnectData(BaseModel):
    """Data model for connecting to a bot.
